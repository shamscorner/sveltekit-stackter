...
const buttonVariants = tv({
	...
	variants: {
		variant: {
			...
			secondary: 'bg-secondary-light text-secondary-foreground hover:bg-secondary/80',
			ghost: 'hover:bg-accent hover:text-accent-foreground',
			link: 'text-primary underline-offset-4 hover:underline',
			complement: 'border-2 border-primary hover:bg-primary hover:text-primary-foreground'
		},
		size: {
